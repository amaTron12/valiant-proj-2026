...
const BASE_URL = 'https://api.petinsuranceclaims.com'
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        {[
          { icon: Key,          color: 'text-blue-500',   label: 'API Keys',           value: tokens.filter(t => t.status === 'Active').length,  sub: `${tokens.length} total` },
